...
[Владимир Дронов, Николай Прохоренок - Python 3 и PyQt 5. Разработка приложений(ru)](https://yadi.sk/i/pwuowaV6csQrHA)
Хорошая книга как для начинающих, так и для знающих. В первой части знакомство с самим языком Python, вторая часть посвящена написанию десктопных приложений с помощью PyQt5.
#beginner
