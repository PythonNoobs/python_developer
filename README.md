...
ОПИСАНИЕ: В этом репозитории находится информация о видео, интерактивных, и прочих курсах обучения языку программирования Python.

# СОДЕРЖАНИЕ:

- [ДОРОЖНАЯ КАРТА ОБУЧЕНИЮ PYTHON](https://github.com/PythonNoobs/python_developer/blob/master/Road_map.md)
В этом разделе подобраны проверенные нами материалы, если вы новичок в программировании и хотите качественно изучить Python "с нуля"
...
В разделе подобраны различные web-ресурсы, сопутствующие изучению программирования.  
