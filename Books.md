...
# НА РУССКОМ ЯЗЫКЕ
## УРОВЕНЬ BEGINNER:
[Секреты Python. 59 рекомендаций по написанию эффективного кода. - Бретт Слаткин] (https://yadi.sk/i/zPewMAs2yOOlvQ)
...
[Python на примерах – Васильев А. Н. (ru)](https://yadi.sk/i/izuKjDydzvSQUA)
Книга старается восполнить недостаток практического материала, содержит множество примеров с комментариями.
#beginner

[Учимся программировать вместе с Питоном (Start with Python) – Чаплыгин А. Н. (ru)](https://yadi.sk/i/GWKGdF9ybq8_yw)
Книга научит думать как программист: сочетать подходы из математики, естественных наук и инженерии.
#beginner

[Основы программирования на примере языка Python  – Федоров Д. Ю. (ru)](https://yadi.sk/i/GWKGdF9ybq8_yw)
Цель пособия – рассказать об основах программирования для слушателей с минимальным знанием информатики.
#beginner

[Изучаем Python. Программирование игр, визуализация данных, веб-приложения – Эрик Мэтиз (ru)](https://yadi.sk/i/q_FQLDQrVh-kEA)
...
[Hello World! Занимательное программирование – Уоррен Сэнд и Картер Сэнд (ru) 2016](https://yadi.sk/i/80TdbjeQnYUo_g)
...
[Автоматизация рутинных задач с помощью Python – Эл Свейгарт (ru) 2017](https://yadi.sk/i/SbbyIj3pPqAIgg)
...
[Уроки Python – Абдрахманов М.И. (ru) 2017](https://yadi.sk/d/DZsR0Hgu8JbmvQ)
...
[Python для детей – Джейсон Бриггс (ru) 2017](https://yadi.sk/i/eVQ1NB0HhcDcjw)
Позволит погрузиться в программирование и освоить Python, написать несколько настоящих игр. Книга для детей от 10 лет.
#beginner

[Основы программирования на примере языка Python – Д. Федоров (ru) 2018](https://yadi.sk/i/FKk8wXi6EXuYSA)
В основу пособия положен цикл занятий, проведенных автором для студентов СПбГЭУ и слушателей курсов Epic Skills.
#beginner

[Программирование на языке Python – Р. Седжвик, К. Уэйн, Р. Дондеро (ru) 2017](https://yadi.sk/i/XDAqcL7QYB8o-Q)
Книга о фундаментальных концепциях программирования, с примерами на Python.
#beginner

[Введение в программирование на Python – Ч. Северенс (ru) 2016](https://yadi.sk/i/vt2pYjtzO82xOg)
Дает представление о базовых понятиях программирования (данных, операциях, переменных, ветвлениях, циклах, функциях).
#beginner

[Программирование для детей. Руководство по языкам Scratch и Python – Вордерман К. (ru) 2015](https://yadi.sk/i/atUsJMRNCs__Ng)
Научит создавать игры и анимацию, а иллюстрации помогут разобраться в основах программирования. 
#beginner

[Изучаем программирование на Python – Пол Берри (ru) 2017](https://yadi.sk/i/uY5hrXLpip1m-A)
...
[Простой Python. Современный стиль программирования – Билл Л. (ru) 2016](https://yadi.sk/i/7o-cfd0Mg9_Apg)
Для начинающих и тех, кто уже имеет опыт программирования. Рассматриваются современные пакеты и библиотеки Python.
#beginner

[Легкий способ выучить Python – Зед Шоу (ru) 2017](https://yadi.sk/i/Y6pT1KZP3p9tGg)
...
[Построение систем машинного обучения на языке Python – Л. П. Коэльо и В. Ричарт (ru) 2016](https://yadi.sk/i/TVZeaLOHiV_1ng)
...
[Программирование на Python, II том – Лутц М. (ru) 2011](https://yadi.sk/i/rfUKUI8wKB-tUQ)
Учебник по применению языка Python в системном администрировании, для создания графических интерфейсов и веб-приложений.
#middle
...
[Intermediate Python – M. Yasoob Ullah Khalid (ru)](https://yadi.sk/i/57nuDx57FWqLfg)
Интересные темы, которые стоит изучить.
#middle

[Python для сетевых инженеров – Н. Самойленко (ru) 2017](https://yadi.sk/i/eH0nXait77bclw)
...
[Введение в машинное обучение с помощью Python – А. Мюллер, С. Гвидо (ru) 2017](https://yadi.sk/i/prHPIcTs_EQ1Ag)
Книга адресована действующим и начинающим специалистам по машинному обучению, решающим реальные задачи.
#middle

[Python 3 и PyQt 5. Разработка приложений – Прохоренок Н. А., Дронов В. А. (ru) 2016](https://yadi.sk/i/7o-cfd0Mg9_Apg)
...
[Python Cookbook – D. Beazley, B. Jones (ru) 2013](https://yadi.sk/i/vt2pYjtzO82xOg)
Сборник рецептов и лучших практик для Python 3.
#middle

[Python и машинное обучение – С. Рашка (ru) 2017](https://yadi.sk/i/6bNk5haV3MqpaQ)
...
[Алгоритмы. Справочник – Дж. Хайнеман, Г. Поллис, С. Селков (ru) 2017](https://yadi.sk/i/xAGL4nYfUIsabg)
Описаны наиболее важные алгоритмы, код написан на Python, C/C++, Java.
#middle

[Python для сложных задач – Дж. Вандер Плас (ru) 2018](https://yadi.sk/i/uY5hrXLpip1m-A)
Поможет изучить DS при помощи IPython, Jupyter, NumPy, Pandas, Matplotlib, Scikit-Learn.
#middle

[Скрапинг веб-сайтов с помощью Python – Р. Митчелл (ru) 2016](https://yadi.sk/i/qLvRUx8bk3gQlg)
...
[Python на практике – Марк Саммерфилд (ru) 2014](https://yadi.sk/i/57nuDx57FWqLfg)
Поможет сделать ваши программы качественнее, надежнее, быстрее и удобнее для сопровождения и использования.
#senior

[Python в системном администрировании UNIX и Linux – Ноа Гифт и Джереми М. Джонс (ru) 2009](https://yadi.sk/i/4YAogOzrTAufGg)
